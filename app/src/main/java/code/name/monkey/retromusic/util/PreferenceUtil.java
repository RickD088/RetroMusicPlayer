...
import static code.name.monkey.retromusic.abram.Constants.UI_DEFAULT_USERNAME;
...
public final class PreferenceUtil {
    ...
    private static final String FREE_PRIZES_AVAILABLE = "free_prizes_available_";

    private static final String PLAYING_TIME = "playing_time";
    ...
    private static final String CLAIM_LATEST_DATE = "claim_latest_date";

    private static final String CLAIM_TASK_LATEST_DATE = "claim_latest_date_task_";

    private static final String CLAIM_ALL_TASK_LATEST_DATE = "claim_all_task_latest_date";
    ...
    public List<CategoryInfo> getDefaultLibraryCategoryInfos() {
        ...
        defaultCategoryInfos.add(new CategoryInfo(Category.GIFT, true));
    ...
    public String getUserName() {
        return mPreferences.getString(USER_NAME, UI_DEFAULT_USERNAME);
    }
    ...
    public Long getFreePrizesAvailableTime(int index) {
        return mPreferences.getLong(FREE_PRIZES_AVAILABLE + index, 0);
    }

    public void setFreePrizesAvailableTime(int index, long availableTime) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putLong(FREE_PRIZES_AVAILABLE + index, availableTime);
        editor.apply();
    }

    public String getPlayingTime() {
        return mPreferences.getString(PLAYING_TIME, "");
    }

    public void setPlayingTime(String dateAndTime) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putString(PLAYING_TIME, dateAndTime);
        editor.apply();
    }

    public String getDownloadCount() {
        return mPreferences.getString(DOWNLOAD_COUNT, "");
    }

    public void setDownloadCount(String dateAndCount) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putString(DOWNLOAD_COUNT, dateAndCount);
        editor.apply();
    }

    public String getSearchCount() {
        return mPreferences.getString(SEARCH_COUNT, "");
    }

    public void setSearchCount(String dateAndCount) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putString(SEARCH_COUNT, dateAndCount);
        editor.apply();
    }

    public String getPlayCount() {
        return mPreferences.getString(PLAY_COUNT, "");
    }

    public void setPlayCount(String dateAndCount) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putString(PLAY_COUNT, dateAndCount);
        editor.apply();
    }

    public String getSpinCount() {
        return mPreferences.getString(SPIN_COUNT, "");
    }

    public void setSpinCount(String dateAndCount) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putString(SPIN_COUNT, dateAndCount);
        editor.apply();
    }

    public String getClaimLatestDate() {
        return mPreferences.getString(CLAIM_LATEST_DATE, "");
    }

    public void setClaimLatestDate(String date) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putString(CLAIM_LATEST_DATE, date);
        editor.apply();
    }

    public String getClaimAllTaskLatestDate() {
        return mPreferences.getString(CLAIM_ALL_TASK_LATEST_DATE, "");
    }

    public void setClaimAllTaskLatestDate(String date) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putString(CLAIM_ALL_TASK_LATEST_DATE, date);
        editor.apply();
    }

    public String getClaimTaskLatestDate(int index) {
        return mPreferences.getString(CLAIM_TASK_LATEST_DATE + index, "");
    }

    public void setClaimTaskLatestDate(int index, String date) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putString(CLAIM_TASK_LATEST_DATE + index, date);
        editor.apply();
    }
}
